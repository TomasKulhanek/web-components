...
const createWebComponentClassFromBehavior = (container, behavior, viewResources, compiler) => {
    const CustomElementClass = class extends HTMLElement {
        ...
        auInit() {
            ...
            const targetInstruction = TargetInstruction.normal(0, 0, [behavior.target], [behaviorInstruction], emptyArray, behaviorInstruction);
...
class CustomElementRegistry {
    ...
    register(Type) {
        let htmlBehaviorResource = metadata.get(metadata.resource, Type);
